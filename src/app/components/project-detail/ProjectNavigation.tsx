  ...
  return (
    <section ref={ref} className="relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 relative">
        ...
        <div
          className="hidden md:block absolute left-1/2 top-0 bottom-0 line-vertical z-10"
          aria-hidden="true"
        />
        ...
        {prev && (
          ...
          >
            ...
            >
              <span>&larr;</span> Projet précédent
            </span>
            <span
            ...
            <span
              className="text-[11px] tracking-[0.2em] uppercase text-[var(--nx-ivory-ghost)] mt-2"
              style={{ fontFamily: "var(--font-mono)" }}
            >
              {prev.category}
            </span>
